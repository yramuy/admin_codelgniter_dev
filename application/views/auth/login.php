        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="post" action="<?php echo base_url('auth/check_login'); ?>">
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" name="user_name" placeholder="Username">
                </div>
                <div class="form-group">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Don't have an account? <a href="<?php echo base_url('auth/signup') ?>" class="text-primary">Create</a>
                </div>
              </form>
            </div>
          </div>
